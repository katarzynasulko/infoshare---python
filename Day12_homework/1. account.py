...
class Saving_Account(Account):
    def __init__(self, firstname, lastname, account_number, money, currency):
        super().__init__(firstname, lastname, account_number, money, currency)
        self.percentage = 0.5

    def calculate_savings(self):
        final_money =self.money + (self.money * self.percentage)
        print(f'Stan konta {self.lastname} po oprocentowaniu: {final_money}')

class Vip_saving_account(Account):
    def __init__(self, firstname, lastname, account_number, money, currency):
        super().__init__(firstname, lastname, account_number, money, currency)
        self.percentage = 0.7
...
if __name__ == '__main__':
    ...
    Kowalska2 = Saving_Account('Pola', 'Kowalska2', 889990, 500, 'zl')
    Kowalska2.calculate_savings()
    Pawlowski2 = Vip_saving_account('Adam', 'Pawlowski', 944523, 700, 'zl')
    Pawlowski2.calculate_savings()
